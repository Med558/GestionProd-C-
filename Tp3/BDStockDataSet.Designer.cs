...
namespace Tp3 {
    ...
    public partial class BDStockDataSet : global::System.Data.DataSet {
        ...
        public partial class FactureDataTable : global::System.Data.TypedTableBase<FactureRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public FactureRow AddFactureRow(long CodeFacture, int CodeClient, System.DateTime DateFacture, double Retenue) {
        ...
        public partial class ProduitDataTable : global::System.Data.TypedTableBase<ProduitRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProduitRow AddProduitRow(int CodeProduit, int CodeFourn, string NomProduit, int PrixUnitaire, int QtEnStock) {
        ...
        public partial class ProduitRow : global::System.Data.DataRow {
            ...
            public int PrixUnitaire {
                get {
                    try {
                        return ((int)(this[this.tableProduit.PrixUnitaireColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
SELECT CodeFacture, CodeClient, DateFacture, Retenue FROM Facture WHERE (CodeFacture = @CodeFacture)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(global::System.Nullable<long> Original_CodeFacture, int Original_CodeClient, global::System.Nullable<global::System.DateTime> Original_DateFacture, global::System.Nullable<double> Original_Retenue) {
            if ((Original_CodeFacture.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((long)(Original_CodeFacture.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<long> CodeFacture, int CodeClient, global::System.Nullable<global::System.DateTime> DateFacture, global::System.Nullable<double> Retenue) {
            if ((CodeFacture.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[0].Value = ((long)(CodeFacture.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<long> CodeFacture, int CodeClient, global::System.Nullable<global::System.DateTime> DateFacture, global::System.Nullable<double> Retenue, global::System.Nullable<long> Original_CodeFacture, int Original_CodeClient, global::System.Nullable<global::System.DateTime> Original_DateFacture, global::System.Nullable<double> Original_Retenue) {
            if ((CodeFacture.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((long)(CodeFacture.Value));
            }
            else {
            ...
            if ((Original_CodeFacture.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((long)(Original_CodeFacture.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CodeClient, global::System.Nullable<global::System.DateTime> DateFacture, global::System.Nullable<double> Retenue, global::System.Nullable<long> Original_CodeFacture, int Original_CodeClient, global::System.Nullable<global::System.DateTime> Original_DateFacture, global::System.Nullable<double> Original_Retenue) {
...
SELECT CodeFourn, NomPrenom, Adresse, Telephone, Fax FROM Fournisseur WHERE (CodeFourn = @CodeFourn)";
    ...
    public partial class ProduitTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Produit] WHERE (([CodeProduit] = @Original_CodeProduit) AND ([CodeFourn] = @Original_CodeFourn) AND ((@IsNull_PrixUnitaire = 1 AND [PrixUnitaire] IS NULL) OR ([PrixUnitaire] = @Original_PrixUnitaire)) AND ((@IsNull_QtEnStock = 1 AND [QtEnStock] IS NULL) OR ([QtEnStock] = @Original_QtEnStock)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_PrixUnitaire", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PrixUnitaire", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT CodeProduit, CodeFourn, NomProduit, PrixUnitaire, QtEnStock FROM Produit WHERE (CodeProduit = @CodeProduit)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PrixUnitaire", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PrixUnitaire", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Produit] SET [CodeProduit] = @CodeProduit, [CodeFourn] = @CodeFourn, [NomProduit] = @NomProduit, [PrixUnitaire] = @PrixUnitaire, [QtEnStock] = @QtEnStock WHERE (([CodeProduit] = @Original_CodeProduit) AND ([CodeFourn] = @Original_CodeFourn) AND ((@IsNull_PrixUnitaire = 1 AND [PrixUnitaire] IS NULL) OR ([PrixUnitaire] = @Original_PrixUnitaire)) AND ((@IsNull_QtEnStock = 1 AND [QtEnStock] IS NULL) OR ([QtEnStock] = @Original_QtEnStock)));
SELECT CodeProduit, CodeFourn, NomProduit, PrixUnitaire, QtEnStock FROM Produit WHERE (CodeProduit = @CodeProduit)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PrixUnitaire", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PrixUnitaire", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_PrixUnitaire", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PrixUnitaire", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_CodeProduit, int Original_CodeFourn, global::System.Nullable<int> Original_PrixUnitaire, global::System.Nullable<int> Original_QtEnStock) {
            ...
            if ((Original_PrixUnitaire.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_PrixUnitaire.Value));
            }
            else {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[3].Value = global::System.DBNull.Value;
            ...
            if ((Original_QtEnStock.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_QtEnStock.Value));
            }
            else {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[5].Value = global::System.DBNull.Value;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int CodeProduit, int CodeFourn, string NomProduit, global::System.Nullable<int> PrixUnitaire, global::System.Nullable<int> QtEnStock) {
            ...
            if ((PrixUnitaire.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(PrixUnitaire.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CodeProduit, int CodeFourn, string NomProduit, global::System.Nullable<int> PrixUnitaire, global::System.Nullable<int> QtEnStock, int Original_CodeProduit, int Original_CodeFourn, global::System.Nullable<int> Original_PrixUnitaire, global::System.Nullable<int> Original_QtEnStock) {
            ...
            if ((PrixUnitaire.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(PrixUnitaire.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
            ...
            if ((Original_PrixUnitaire.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_PrixUnitaire.Value));
            }
            else {
            ...
            if ((Original_QtEnStock.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_QtEnStock.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int CodeFourn, string NomProduit, global::System.Nullable<int> PrixUnitaire, global::System.Nullable<int> QtEnStock, int Original_CodeProduit, int Original_CodeFourn, global::System.Nullable<int> Original_PrixUnitaire, global::System.Nullable<int> Original_QtEnStock) {
            return this.Update(Original_CodeProduit, CodeFourn, NomProduit, PrixUnitaire, QtEnStock, Original_CodeProduit, Original_CodeFourn, Original_PrixUnitaire, Original_QtEnStock);
        }
    }
